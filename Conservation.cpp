...
TH1D* h1 = new TH1D("h1", "Initial X-Direction Momentum Distribution (first file, all events)", 500, -2.5, 2.5);
h1->GetXaxis()->SetTitle("Momentum [GeV/c]");
h1->GetYaxis()->SetTitle("Number of Particles");

TH1D* h2 = new TH1D("h2", "Initial Y-Direction Momentum Distribution (first file, all events)", 500, -2.5, 2.5);
h2->GetXaxis()->SetTitle("Momentum [GeV/c]");
h2->GetYaxis()->SetTitle("Number of Particles");

TH1D* h3 = new TH1D("h3", "Initial Z-Direction Momentum Distribution (first file, all events)", 500, -15, 15);
h3->GetXaxis()->SetTitle("Momentum [GeV/c]");
h3->GetYaxis()->SetTitle("Number of Particles");

TH1D* h4 = new TH1D("h4", "Freeze-Out X-Direction Momentum Distribution (first file, all events)", 500, -2.5, 2.5);
h4->GetXaxis()->SetTitle("Momentum [GeV/c]");
h4->GetYaxis()->SetTitle("Number of Particles");

TH1D* h5 = new TH1D("h5", "Freeze-Out Y-Direction Momentum Distribution (first file, all events)", 500, -2.5, 2.5);
h5->GetXaxis()->SetTitle("Momentum [GeV/c]");
h5->GetYaxis()->SetTitle("Number of Particles");

TH1D* h6 = new TH1D("h6", "Freeze-Out Z-Direction Momentum Distribution (first file, all events)", 500, -15, 15);
...
class momentum {
    ...
    ifstream f13file;
    f13file.open("F7FE55EFC32E77DAA45DA45DCD7091A8_0 (2).f13");
